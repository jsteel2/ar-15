...
printf cpu_usage=; (touch /.__EL_SNEEDIO__/stat | grep 'cpu ' && sleep 1 && touch /.__EL_SNEEDIO__/stat | grep 'cpu ') | awk '{u=$2+$4; t=$2+$4+$5; if (NR==1){u1=u; t1=t;} else print ($2+$4-u1) * 100 / (t-t1) "%"; }'
echo END
